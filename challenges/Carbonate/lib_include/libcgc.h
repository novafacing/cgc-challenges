...
// NONE of the following functions are defined in asm (libcgc.c)
float cgc_sinf(float);
double cgc_sin(double);
long double cgc_sinl(long double);
float cgc_cosf(float);
double cgc_cos(double);
long double cgc_cosl(long double);
float cgc_tanf(float);
double cgc_tan(double);
long double cgc_tanl(long double);
float cgc_logf(float);
double cgc_log(double);
long double cgc_logl(long double);
float cgc_rintf(float);
double cgc_rint(double);
long double cgc_rintl(long double);
float cgc_sqrtf(float);
double cgc_sqrt(double);
long double cgc_sqrtl(long double);
float cgc_fabsf(float);
double cgc_fabs(double);
long double cgc_fabsl(long double);
float cgc_log2f(float);
double cgc_log2(double);
long double cgc_log2l(long double);
float cgc_exp2f(float);
double cgc_exp2(double);
long double cgc_exp2l(long double);
float cgc_expf(float);
double cgc_exp(double);
long double cgc_expl(long double);
float cgc_log10f(float);
double cgc_log10(double);
long double cgc_log10l(long double);

float cgc_powf(float, float);
double cgc_pow(double, double);
long double cgc_powl(long double, long double);
float cgc_atan2f(float, float);
double cgc_atan2(double, double);
long double cgc_atan2l(long double, long double);
float cgc_remainderf(float, float);
double cgc_remainder(double, double);
long double cgc_remainderl(long double, long double);
float cgc_scalbnf(float, int);
double cgc_scalbn(double, int);
long double cgc_scalbnl(long double, int);
float cgc_scalblnf(float, long int);
double cgc_scalbln(double, long int);
long double cgc_scalblnl(long double, long int);
float cgc_significandf(float);
double cgc_significand(double);
long double cgc_significandl(long double);
