...
// Hardware functions
gb_t *cgc_gb_new();
void cgc_gb_reset(gb_t *gb);
int cgc_gb_load(gb_t *gb, uint8_t *cartridge);
int cgc_gb_tick(gb_t *gb);

// CPU functions
int cgc_cpu_tick(gb_t *gb);
void cgc_cpu_interrupt(gb_t *gb, int n);

// LCD functions
int cgc_lcd_tick(gb_t *gb);
